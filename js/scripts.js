...
function randomizer()    //get a rand num 0-9
  {
  var randomNum;
...
function randomQuote() {  //use the random number to pick a quote
  var num = randomizer();
  var quotes =
      [
  ...
  var person =
    ...
    quoteStore = quotes[num]    //for twitter
    quoteSource = person[num]   //for twitter
}
